...
/**
 * generate MoMo pins - generates all possible PINS
 * @pins: array of digits
 * @index: index of the array of digits
 * @file: file to write to(generated_paaswords.txt)
 *
 * Return: void
 */
...
/**
 * printPIN - prints a PIN NUMBER
 * @pin: array of digit pins
 * @file: file to write to(generated_paaswords.txt)
 * Return: void
 */
void printPin(int *pin, FILE *file)
